...
(function (window, document, $) {
	...
	$.extend(F, {
		...
		defaults: {
			...
			fixed: !(navigator.appName == 'Microsoft Internet Explorer') || $.browser.version > 6 || !document.documentElement.hasOwnProperty('ontouchstart'),
			...
			tpl: {
				...
				iframe: '<iframe class="fancybox-iframe" name="fancybox-frame{rnd}" frameborder="0" hspace="0" ' + ((navigator.appName == 'Microsoft Internet Explorer') ? 'allowtransparency="true""' : '') + ' scrolling="{scrolling}" src="{href}"></iframe>',
