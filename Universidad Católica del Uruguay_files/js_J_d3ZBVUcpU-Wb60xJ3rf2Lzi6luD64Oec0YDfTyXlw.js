...
/**
 * Función que adapta el sitio a mobile. Implementada por KDB
 */
function mobile_kdb() {
//    jQuery("#block-muchomenu-1").slicknav();
    ...
    jQuery('#muchomenu-1').prependTo("#mobile-menu .content");
    jQuery('#muchomenu-1').insertAfter(jQuery("#muchomenu-1").next());
    jQuery("#mobile-menu *").removeClass (function (index, css) {
   ...
   if(jQuery('#menu-attached-button').size()){
        jQuery('#menu-attached-button').siblings("ul").css('background','transparent');
          jQuery('#mobile-navigation-mask').click(function () {
               if(jQuery('#menu-attached-button').hasClass('active')){
               jQuery('#menu-attached-button').siblings("ul").css('background','#ffffff');
               }
               else{
                   jQuery('#menu-attached-button').siblings("ul").css('background','transparent');
    ...
    if(jQuery('#menu-attached-button').size()){
        jQuery('#menu-attached-button').siblings("ul").css('background','transparent');
          jQuery('#menu-attached-button').click(function () {
               if(jQuery('#menu-attached-button').hasClass('active')){
               jQuery('#menu-attached-button').siblings("ul").css('background','#ffffff');
               }
               else{
    ...
    // Maquetado p
    if(jQuery("#main_contents .contents #portal-menu").size()) {

        // insertAfter

        jQuery("#mobile-menu #muchomenu-1").remove();
        jQuery("#mobile-menu li").remove();
        if( jQuery("#mobile-menu > div > ul").size() ) {
            jQuery("#main_contents .contents #portal-menu .nice-menu > li").clone().appendTo("#mobile-menu > div > ul");
        } else {
            jQuery("#main_contents .contents #portal-menu .nice-menu > li").clone().appendTo("#mobile-menu");
        }
    }
